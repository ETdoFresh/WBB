...
function Steering.new(param)
	...
	function self:setSteering(input)
		...
		if (input == "seek" and param.target) then steeringType = Seek.new(param)
		elseif (input == "arrive" and param.target) then steeringType = Arrive.new(param)
		elseif (input == "pursue" and param.target) then steeringType = Pursue.new(param)
		elseif (input == "align" and param.target) then steeringType = Align.new(param)
		elseif (input == "face" and param.target) then steeringType = Face.new(param)
